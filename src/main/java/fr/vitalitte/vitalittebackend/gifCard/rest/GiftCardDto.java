...
public class GiftCardDto {
    ...
    public GiftCardDto(String code, BigDecimal rising, LocalDateTime expiryDate, boolean isPercentage, boolean isSingleUse) {
        this.code = code;
        this.rising = rising;
    ...
    public static GiftCardDtoBuilder builder() {
        return new GiftCardDtoBuilder();
    }
    ...
    public static class GiftCardDtoBuilder {
        ...
        public GiftCardDtoBuilder isSingleUse(boolean isSingleUse) {
            this.isSingleUse = isSingleUse;
            return this;
        }
