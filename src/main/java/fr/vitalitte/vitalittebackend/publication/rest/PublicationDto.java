...
public class PublicationDto {
    ...
    public PublicationDto(String slug, String title, String description, String picture, boolean isSpotlighted, Timestamp createdAt) {
        this.slug = slug;
        this.title = title;
    ...
    public static PublicationDtoBuilder builder(){ return new PublicationDtoBuilder();}
    public static class PublicationDtoBuilder {
        ...
        public PublicationDto build(){
            return new PublicationDto(this.slug, this.title, this.description, this.picture, this.isSpotlighted, this.createdAt);
        }
    }
}
